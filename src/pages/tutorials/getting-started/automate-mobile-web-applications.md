...
[create project mobile web (video)](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/create_project_mobile_web.mp4)
...
[mobile web recorder (video)](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/mobile_web_recorder.mp4)
...
![navigate_nlp](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/navigate_nlp.png)
...
![nlp_step2](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/nlp_step2.png)
...
* Pre-capture them using our recorder. **Here’s a video** that will help guide you through capturing all your elements and saving them to your repository.
   [capture_elements(video)](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/capture_elements.mp4)
...
* The second method is creating an element in real time while creating your test step. For this:
    ...
    * Click on ‘New’ highlighted in green.
      ...
      ![elements_test_data](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/elements_test_data.png)
    ...
    * You can either **manually** enter the **selector value**
      ...
      ![manual_recorder](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/manual_recorder.gif)
...
![login_nlp_step](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/login_nlp_step.png)
...
![mobile_web_nlp](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/mobile_web_nlp.png)
...
![run_mobile_web_test](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/run_mobile_web_test.png)
...
![analyze_results](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/analyze_results.png)
...
![dry_run_mobileweb](https://docs.testsigma.com/tutorials/videos/getting-started-mobile-web/dry_run_mobileweb.gif)
