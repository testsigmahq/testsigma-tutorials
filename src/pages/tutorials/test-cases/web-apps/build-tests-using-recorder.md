...
![step_group_recorder](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/step_group_recorder.png)
...
![step_options](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/step_options.png)
...
![web_recorder_Tutorial_2](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/web_recorder_Tutorial_2.png)

3. Click on More Filters
   
4. Click on Apply

![web_recorder_Tutorial_3](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/web_recorder_Tutorial_3.png)

5. Click on Sort By

6. Click on Book Now for any of the flight options

![web_recorder_Tutorial_4](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/web_recorder_Tutorial_4.png)
...
![web_recorder_Tutorial_5](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/web_recorder_Tutorial_5.png)
...
![web_recorder_Tutorial_6](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/web_recorder_Tutorial_6.png)
...
![web_recorder_Tutorial_7](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/web_recorder_Tutorial_7.png)
...
![run_web_recorder](https://docs.testsigma.com/tutorials/videos/build-tests-using-recorder-web/run_web_recorder.png)
