    ...
    return (
        <>
            <div className="w-full md:px-16 home-page_banner">
                <h1 className="text-4xl font-bold">Testsigma Tutorials</h1><br/>
                <span className="text-base font-normal">A Complete collection of tutorials guide you through test automation in Testsigma.</span>
            </div>
...
const Index = () => {
    return (
        <Layout>
            <SEO
                title={`Testsigma Learning Tutorials and Guides | Testsigma`}
                slug={`/tutorials/`}
                canonical={`/tutorials/`}
                metadesc={`Learn more about testsigma products and full guide to test automation journey from this Testsigma learning tutorials.`}
                keywords={`Testsigma Tutorials`}
                social_share_summary={`summary_large_image`}
                social_share_desc={`Learn more about testsigma products and full guide to test automation journey from this Testsigma learning tutorials.`}
